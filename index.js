...
function start(client){
    client.onMessage(async message => {
        ...
        const botNumber = "15595265717@c.us"; // Specify your botNumber here
        const botOwner = "15595265717"; //Specify bot owner number here
        ...
        if(command === '!animated' || command === '#animated') {
        ...
        if(command === "!abuse"){
            ...
            try {
                ...
                if(isGroupMsg){
                    ...
                    const pathList = ["hindustani_nikal_lavde.mp3","ae_ji_gaali_de_raha.mp3","dadda_addha.mp3","roti_chawal.mp3","rowdy_abuse.mp3","chal_bsdk.mp3","pramod_dubey_maa_chod.mp3","teri_ma_ki.mp3","hatt_teri.mp3","tori_maa.mp3","chut_faad.mp3","patak.mp3"]
